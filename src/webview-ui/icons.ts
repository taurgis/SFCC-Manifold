...
export const iconSvgs = {
  ...
  merge:
    '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="18" cy="18" r="3"/><circle cx="6" cy="6" r="3"/><circle cx="6" cy="18" r="3"/><path d="M6 9v6"/><path d="M18 9a9 9 0 0 0-9 9"/></svg>',
  repeat:
...
export function getNodeTypeIcon(type: string): string {
  switch (type) {
    ...
    case "end":
      return iconSvgs.stop;
    case "pipelet":
      return iconSvgs.box;
    case "call":
      return iconSvgs.phoneCall;
    case "jump":
      return iconSvgs.arrowRight;
    case "interaction":
      return iconSvgs.user;
    case "decision":
      return iconSvgs.gitBranch;
    case "join":
      return iconSvgs.merge;
    case "loop":
      return iconSvgs.repeat;
    case "text":
      return iconSvgs.text;
    default:
      return iconSvgs.circle;
  }
}
